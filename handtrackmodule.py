...
class Handdetector:
    ...
    def __init__(self, mode=False,maxhands=2,detectionconf=0.5,trackingconf=0.5,handno=0):
        self.mode = mode
    ...
    def findposition(self,img,draw=True):
        ...
        lmlist=[]
        if self.results.multi_hand_landmarks:
            handnum=len(self.results.multi_hand_landmarks)+1
            if handnum >= self.handno:
                myhand = self.results.multi_hand_landmarks[self.handno-1]
